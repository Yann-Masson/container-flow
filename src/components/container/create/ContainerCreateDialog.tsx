                                            ...
                                            <Card className='relative border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/[0.07]'>
                                                ...
                                                <CardContent>
                                                    <div className='space-y-2'>
                                                        ...
                                                        {labels.length === 0 && (
                                                            <p className='text-sm text-muted-foreground text-center py-4'>
                                                                No labels defined. Click "Add Label"
                                                                to add one.
                                                            </p>
                                                        )}
                                                    </div>
                                            ...
                                            <Card className='relative border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/[0.07]'>
                                                ...
                                                <CardContent>
                                                    <div className='space-y-2'>
                                                        ...
                                                        {ports.length === 0 && (
                                                            <p className='text-sm text-muted-foreground text-center py-4'>
                                                                No port mappings defined. Click "Add
                                                                Port" to add one.
                                                            </p>
                                                        )}
                                                    </div>
                                            ...
                                            <Card className='relative border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/[0.07]'>
                                                ...
                                                <CardContent>
                                                    <div className='space-y-3'>
                                                        ...
                                                        {volumes.length === 0 && (
                                                            <p className='text-sm text-muted-foreground text-center py-4'>
                                                                No volume mappings defined. Click
                                                                "Add Volume" to add one.
                                                            </p>
                                                        )}
                                                    </div>
                                                </CardContent>
