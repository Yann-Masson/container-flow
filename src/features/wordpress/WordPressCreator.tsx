...
import { createWordPressProject, fetchContainers } from '@/store/slices/containerSlice';
import { selectIsCreating, selectProjects } from '@/store/selectors/containerSelectors';
...
export default function WordPressCreator({ onProjectCreated: onProjectCreated, disabled = false }: WordPressCreatorProps) {
